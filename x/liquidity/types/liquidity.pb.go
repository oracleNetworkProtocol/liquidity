...
// WithdrawSuccessMsg defines the state of the withdraw message that contains state information as the message is processed in the next batch or batches.
type WithdrawSuccessMsg struct {
	...
	MsgIndex uint64 `protobuf:"varint,2,opt,name=msg_index,json=msgIndex,proto3" json:"msg_index,omitempty" yaml:"msg_index"`
	// Successfully deposit quantity
	WithdrawCoins github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,3,rep,name=withdraw_coins,json=withdrawCoins,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"withdraw_coins" yaml:"withdraw_coins"`
	// Successfully deposit quantity
	WithdrawFeeCoins github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,4,rep,name=withdraw_fee_coins,json=withdrawFeeCoins,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"withdraw_fee_coins" yaml:"withdraw_fee_coins"`
	// MsgWithdrawWithinBatch
